...
const appRoutes: Routes = [
  ...
  { path: 'asset-characteristics', loadChildren: '../asset-characteristics/asset.characteristic.module#AssetCharacteristicModule', canLoad: [AuthGuard] },
  { path: 'asset-name-types', loadChildren: '../asset-name-types/asset.name.type.module#AssetNameTypeModule', canLoad: [AuthGuard] },
  { path: 'asset-identifier-types', loadChildren: '../asset-identifier-types/asset.identifier.type.module#AssetIdentifierTypeModule', canLoad: [AuthGuard] },
