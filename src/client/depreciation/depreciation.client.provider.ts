...
export function depreciationClientFactory (uuidGenerator: UUIDGenerator, httpClient: HttpClient): DepreciationClient {
  return new DepreciationClientHttp(uuidGenerator, httpClient);
}
