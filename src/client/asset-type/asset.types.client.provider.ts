...
export function assetTypesClientFactory (httpClient: HttpClient, uuidGenerator: UUIDGenerator): AssetTypesClient {
  ...
  // }
  return new AssetTypesClientHttp(httpClient, uuidGenerator);
}
