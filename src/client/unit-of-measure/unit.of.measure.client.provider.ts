...
export function unitOfMeasureClientFactory (httpClient: HttpClient, uuidGenerator: UUIDGenerator): UnitOfMeasureClient {

  return new UnitOfMeasureClientHttp(uuidGenerator, httpClient);
}
