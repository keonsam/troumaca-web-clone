...
import {depreciationRepositoryProvider} from '../adapter/depreciation/depreciation.repository.adapter.provider';
import {depreciationClientProvider} from '../client/depreciation/depreciation.client.provider';
...
@NgModule({
  ...
  providers: [depreciationServiceProvider,
    depreciationBookResolveProvider,
    depreciationTaxResolveProvider,
